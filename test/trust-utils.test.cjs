...
assert.strictEqual(utils.formatMapName('de_shortdust'), 'Shortdust');
assert.strictEqual(utils.formatMapName('de_lake'), 'Lake');
assert.strictEqual(utils.formatMapName('de_weird_map'), 'Weird Map');
assert.strictEqual(utils.formatRoundReason(99, undefined, 'en'), 'Round completed');
assert.strictEqual(utils.formatRoundReason('defuse', undefined, 'en'), 'Bomb defused');
assert.strictEqual(utils.formatMatchResult('draw', 'ru'), 'Ничья');
